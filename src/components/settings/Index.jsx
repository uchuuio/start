    ...
    return (
      <div>
        <Absolute m={2} bottom left>
          <SettingsButton onClick={this.handleOpenModal}>
            Settings
          </SettingsButton>
        </Absolute>
        ...
        <ReactModal
          ...
          style={{
            overlay: { backgroundColor: '#2A2F3A' },
            content: {},
          }}
        >
          <Provider>
            ...
            <Border pt={3} pb={2} top bottom>
              ...
              <table width="100%" style={{ marginLeft: '-3px' }}>
                ...
                <tbody>
                  <AddLink />
                  {links.map(link => (
                    <SettingsLink key={link.id.toString()} {...link} />
                  ))}
                </tbody>
                <thead>
                  <tr>
            ...
            <Border pt={3} pb={2} top bottom>
              ...
              <UpdateSettings />
              <p>
                Configs for language of datetime, currencies, api, keys &
                enabling modules
              </p>
            </Border>
            <div style={{ textAlign: 'center' }}>
              ...
              <p>BETA V6</p>
              <p>
                All configs and links are stored in your browser&apos;s
                localstorage.
              </p>
              <p>
                Built with React, Redux &amp; alot of effort by
                <a
                  href="https://tomo.uchuu.io"
                  target="_blank"
              ...
              <p>
                <a
                  href="https://github.com/tomouchuu/start"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Github Repo
